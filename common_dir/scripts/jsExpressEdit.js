	...
	removeFigureSaveCaption   :  function(id,num,msg){
     ...
     updateText : function(track){
          ...
          var html='<div class="altTextAreaShow">Edit&nbsp;InnerHTML:<textarea id="jsTextareaClick_'+this.bid+'_'+track+'" rows="7" onkeyup="gen_Proc.autoGrowFieldScroll(this);">'+text+'</textarea>';
     ...
     //tiny-mce automatically wraps iframes with span and p elements.  Using iframe RWD wrap mode available for iframe videos allows them to respond to view-port changes and rwd class width styles etc. This checks for any tinymce changes to iframe RWD mode
...
var src = elem.attr('src');
	...
	addWrapSelect  :  function(bid,idtag){ 
     ...
     updateSortAllChange  :  function(track){
          ...
          var source=jQuery("["+this.attr+"="+sourcenum+"]");
     ...
     updateAlt : function(track){
          ...
          showObj.removeAttr('class','hide');
          var html='<div class="altImgTextAreaShow">Edit:&nbsp;Alt<textarea id="altImgTextareaClick_'+this.bid+'_'+track+'" onkeyup="gen_Proc.autoGrowFieldScroll(this);">'+alt+'</textarea>';
     ...
     addSibling : function(track){//used separately for iframes
	   ...
	   html+='<p ><input type="radio" name="addNodeType_'+this.bid+'_'+track+'" value="inner">Add Tag around Element Inner Content and keep Outer Tag</p>';
          ...
          '<option value="blockquote">blockquote</option>'+
          '</select></p>';
	  html+='<p onclick="jsExpressEdit.addTargetChange(\'addNodeType_'+this.bid+'_'+track+'\',\''+track+'\');"  class="altSelect cursor underline">Or Click to Choose to a Target Box for Creating New Content Before or after this element</p>';
          html+='</div><!--alt show-->';
          showObj.html(html);
          },
     ...
     updateSrc : function(track){//used separately for iframes
          ...
          showObj.removeAttr('class','hide');
          var html='<div class="altIframeTextAreaShow warnlight">Edit:&nbsp;Src Here Otherwise tinymce will re-generate Old Src<textarea id="altIframeTextareaClick_'+this.bid+'_'+track+'" onkeyup="gen_Proc.autoGrowFieldScroll(this);">'+src+'</textarea>';
     ...
     editNode  : function(obj,nName){
          ...
          var html='<span id="altShow_'+this.bid+'_'+this.track+'" class="altEdButton" title="Edit class and element style values" onclick="gen_Proc.show(\'altShow_'+this.bid+'_'+this.track+'\',\'Edit:Class:Style\',\'asis\',\'600\',\'\');">'+styleT+'</span>';//gen_Proc.adjustLeftMargin(\'altShow_'+this.bid+'_'+this.track+'t'+'\');
     ...
     getUploadSize :function(fn,fdir,id){ gen_Proc.use_ajax(edit_Proc.url+'?return_filesize='+fn+'@@'+fdir+'&id='+id,'handle_replace','get'); 
          },
     changeCurrentSize : function(fn,storedir,fdir,id){
          var vid=document.getElementById(id);
          var value =vid.value;
               gen_Proc.use_ajax(edit_Proc.url+'?tiny_resize='+fn+'@@'+storedir+'@@'+fdir+'@@'+value+'&id='+id+'t','handle_replace','get'); 
          },
     editMultiTools  :  function(id){
         ...
         html+='<p style="height:35px;clear:both;"></p>';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showjQuerySel_'+this.bid+'\',\'hide\');">Input jQuery Format Selector</p>';
          ...
          html+='<p style="height:10px;clear:both;"></p>';
          html+='<p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showAdvancedjQuerySel_'+this.bid+'\',\'hide\');">Advanced Query Format Selector</p>';
          html+='</div><!--wrap advanced-->';
          html+='<div id="showAdvancedjQuerySel_'+this.bid+'" class="hide fsmwhite">';
          
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'advancedhide_'+this.bid+'\',\'hide\');">Advanced Info</p>';
		...
		'</optgroup></select></p>';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showjQueryFindEleClass_'+this.bid+'\',\'hide\');">Use Tag/Classname Selector</p>';
	    ...
	    html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showNumberSel_'+this.bid+'\',\'hide\');">Use Alternative Number Selector</p>';
		...
		//###############  Choose Operation
          ...
          html+='<p style="height:10px;clear:both;"></p>';
          html+='<p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showMultiadddel_'+this.bid+'\',\'hide\');">Add or Delete Class Names To found </p><div id="showMultiadddel_'+this.bid+'" class="hide fsmdarkslategray"><h3>Add or Delete Classes To Found </h3>';
          ...
          //####################Begin Phase2
         html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showMultimove_'+this.bid+'\',\'hide\');">Multi Move Elements </p><div id="showMultimove_'+this.bid+'" class="hide fsmdarkslategray">';
         ...
         html+='<p style="height:10px;clear:both;"></p><p style="height:35px;clear:both;"></p>';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showAdvancedjQuerySel2_'+this.bid+'\',\'hide\');">Advanced Query Format Selector for Destination Target Elements</p>';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showjQueryFindEleClass2_'+this.bid+'\',\'hide\');">Use Tag/Classname Selector</p>';
		...
		html+='<p style="height:10px;clear:both;"></p><p class="altSubmit  leftfloat left" onclick="jsExpressEdit.editMultiToolsChange2( \'jsClassActionSel_'+this.bid+'_'+this.track+'\',\'jsClassActionFE_'+this.bid+'_'+this.track+'\',\'jsClassActionFCN_'+this.bid+'_'+this.track+'\',\'jsClassActionRmCN_'+this.bid+'_'+this.track+'\',\'jsClassActionAdvSel1_'+this.bid+'_'+this.track+'\',\'jsClassActionAdvSel2_'+this.bid+'_'+this.track+'\',\'jsClassActionAdvSel3_'+this.bid+'_'+this.track+'\',\'jsClassActionOP_'+this.bid+'_'+this.track+'\',\'jsClassActionSel2_'+this.bid+'_'+this.track+'\',\'jsClassActionFE2_'+this.bid+'_'+this.track+'\',\'jsClassActionFCN2_'+this.bid+'_'+this.track+'\',\'jsClassActionRmCN2_'+this.bid+'_'+this.track+'\');">Update&nbsp;Multi&amp;Moves</p><p style="clear:both;"></p></div><!--multimove-->';
          //##########
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showMultiwrap_'+this.bid+'\',\'hide\');">Wrap Tags</p><div id="showMultiwrap_'+this.bid+'" class="hide fsmdarkslategray">';
          ...
          //#############
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showMultidelete_'+this.bid+'\',\'hide\');">Delete Element Operations </p><div id="showMultidelete_'+this.bid+'" class="hide fsmdarkslategray">';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showMultiAddTag_'+this.bid+'\',\'hide\');">Create Tags</p><div id="showMultiAddTag_'+this.bid+'" class="hide fsmdarkslategray">';
          html+='<h3>Add Tag To found Class Names</h3>';
          ...
          //##########
		html+='<p style="height:10px;clear:both;"></p>';
		html+='<p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showSearchReplaceEle_'+this.bid+'\',\'hide\');">Search/Replace Elements</p><div id="showSearchReplaceEle_'+this.bid+'" class="hide fsmdarkslategray">';
		...
		html+='<div style="background:#999" class="fsmgreen" ><!--begin Search/replace-->';
          ...
          html+='<p style="height:10px;clear:both;"></p><p class="altUpdate leftfloat left" onclick="gen_Proc.toggle_display(\'showSearchReplace_'+this.bid+'\',\'hide\');">Search Replace</p>';
	...
	editMultiToolsChange6  :  function(idsel,ide,idcn,idrm,idadv1,idadv2,idadv3,idsearch,idreplace){
     ...
     parseNodes   : function(obj){
          ...
          var updateSrc = '<span class="fs1nporange altEdButton" title="Update the Src within this '+nName+'!" onclick="jsExpressEdit.updateSrc('+this.track+',\''+nName+'\');">Edit&nbsp;Src</span><div id="altIframeTextAreaShow_'+this.bid+'_'+this.track+'" style="clear:both;" class="hide "></div>';
          ...
          var removeInfo = '<span class="altEdButton" title="First choose the iframe option to Remove Auto Iframe RWD mode" onclick="gen_Proc.alert(\'Iframe RWD mode applied. First choose the iframe option to Remove Auto Iframe RWD mode ">Remove&nbsp;Info</span>';
           if (nName.indexOf('text')>-1 ){
               ...
               if  (parent.attr('data-mce-p-iframe-level') == 'span'){
                    editStyle = '<span class="altEdButton" title="Edit Parent p for RWD iframe Response using class or style tag" onclick="gen_Proc.alert(\'Iframe RWD mode applied no changes to this span class are needed.  Apply RWD classes/styling and remove the default styling applied in the p element parent that was generated in auto iframe RWD mode. Auto iframe RWD mode may be removed in iframe options\');">Style/Class&nbsp;Info</span>';
               ...
               if ( nName== 'span' && obj.outerHTML.match(/<span.*"><!--Temp br sub--><\/span>/)){
                    ...
                    if ( nName == 'p' && jQuery(obj).attr('data-iframe-level') == 'style-class'){
                         ...
                         editStyle = '<span class="altEdButton" title="Edit Parent Div for RWD iframe Response using class or style tag" onclick="gen_Proc.alert(\'Auto iframe RWD mode applied and no class/styling changes necessary here. Apply RWD classes/styling to the  p element parent which otherwise has default styling which may be removed. Auto iframe RWD mode may be removed..\');">Style/Class&nbsp;Info</span>';
                         removeall=removeInfo;
                         remove='';
                         }
                    else if ( nName == 'span' && jQuery(obj).attr('data-mce-p-iframe-level') == 'span'){
                         var editStyle = '<span class="altEdButton" title="Auto iframe RWD mode applied and no class/styling changes necessary here. Apply RWD classes/styling to the  p element parent which otherwise has default styling which may be removed. Auto iframe RWD mode may be removed" onclick="gen_Proc.alert(\'Iframe RWD mode applied.  Auto iframe RWD mode applied and no class/styling changes necessary here. Apply RWD classes/styling to the  p element parent which otherwise has default styling which may be removed. Auto iframe RWD mode may be removed Auto iframe RWD mode may be removed in iframe options\');">Style/Class&nbsp;Info</span>';
                         removeall=removeInfo;
                         remove='';
                         }
                    var c  = obj.children;
	...
	removeAllAttr  :function(obje){
     ...
     parseTextarea   :  function(cn,bid){
		...
		var sortButton2 = this.sortall ? '<p class="altEdButton rad5" onclick="jsExpressEdit.reboot();">Off Secondary Sort</p>' : '<p class="altEdButton rad5" onclick="jsExpressEdit.reboot(\'sortall\');">Go Sort Mode Secondary</p>';
		...
		var directory= true ? '<p class="altEdButton rad5" onclick="gen_Proc.toggle_display(\'showDirectory_'+bid+'\',\'hide\');">GoTo Element</p><div id="showDirectory_'+bid+'" class=" altSourceEd" style="display:none;"></div>' : ''; 
		var build='<div id="ed_Html_'+bid+'" class="altSysEdit rad10"><div class="altEditTitleContainer"><p class="altEdButton rad5" onclick="jsExpressEdit.closeEditor(\''+bid+'\');">Remove Editor</p>'+goButton+directory+sortButton+sortButton2+'<input class="altEdButton rad5" value="Submit Page Changes" type="submit" name="submit"><p class="altEdButton rad5" onclick="jsExpressEdit.sourceEditor(\''+bid+'\',\'showSourceEdit_'+bid+'\');">Source Editor</p><div id="showSourceEdit_'+bid+'" class="hide  altSourceEd"></div>'+wrapButton+'<p class="altEdButton rad5" onclick="gen_Proc.toggle_display(\'showMultiEdit_'+bid+'\',\'hide\');jsExpressEdit.editMultiTools(\'showMultiEdit_'+bid+'\');">Multi Editor</p><div id="showMultiEdit_'+bid+'" class=" altSourceEd" style="display:none;"></div>  </div><!--alteditTitleContainer-->'+gotoTop;
		this.collect+=build;
     ...
     getNodes   : function(obje){//all nodes
		var ele = (this.sort) ? 'li' : 'div';
          ...
          for(var i=0; i<childNodes.length; i++) {
	       ...
	       var showallnum= !this.sort ? '<span class="openhide tiny darkslategray underline cursor">&nbsp;&nbsp;Show All #s</span>':'';
               this.collect+='<'+ele+' id="edit_track_'+this.track+'" class="altEditNodes box" ><p id="goto'+this.track+'" class="floatleft '+color+'">'+showallnum+'</p>';
