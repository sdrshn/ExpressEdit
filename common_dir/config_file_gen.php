...
echo '<html>
     ...
     <body><b>This file Runs from website home directory site for initial installs and will rerun if Cfg_loc.class.php files are missing!!</b><br><p style="color:red;">'.$msg.'</p>'; 
...
function autoloading($file){
 ...
 spl_autoload_register("autoloading");
     ...
     foreach ($pagetables as $tablename){  
          //if(!array_key_exists($tablename,$table_assoc))continue;
     ...
     echo 'Begin editing Go To <a href="./'.Cfg::PrimeEditDir.'index.php">Edit Home Page</a>"<br><br>';
    
     
  rename (HOME_PUB.'config_file_gen.php',HOME_PUB.'includes/config_file_gen.php');
