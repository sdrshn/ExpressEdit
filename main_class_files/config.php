...
$database_name = "vwpkbpmy_php2";

# who do we log in as?
$database_user = "vwpkbpmy_php2";

# and what password do we use
$database_password = 'wdHWgkvIal';
...
# requires PHP version > "4.0.5" and "4.3.1+" without safe_mode
 $message_envelope = 'bounces@thehcg-coaches.com';
...
$bounce_mailbox_password = 'bounces';
...
define("MAILQUEUE_BATCH_PERIOD",11);
