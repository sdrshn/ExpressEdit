...
static function print_tip2($msg,$size='.9'){
	if(Sys::Printoff||Sys::Quietmode)return;
	echo "\n";
	$msg= '<p class="floatleft clear tip2 editfont" style="font-size:'.($size*16).'px;">'.$msg.'</p>';
	echo $msg;
	self::pclear();
	}
...
static function print_warn($msg,$size='.9'){
...
static function print_custom_wrap($msg,$color,$class){
	...
	$msg= '<div class="bs1'.$color.$class.'"><!--wrap '.$msg.'-->
	<div class="fsm2'.$color.'"><!--second print div wrap-->';
	echo $msg; 
	self::pclear();
	}
...
static function single_custom_wrap($msg,$class){
	...
	echo "\n";  
	$class=' floatleft clear '.$class.' editfont';
	$msg= '<div class="'.$class.'"><!--single custom wrap '.$msg.'-->';
     echo $msg; 
	self::pclear();
	}
...
static function print_wrap($msg,$color='info',$main=false,$class='editbackground editcolor editfont'){
	...
	$msg= '<div class="'.$class1.'"><!--wrap '.$msg.'-->
	<div class="'.$class2.'"><!--second print div wrap-->';
	echo $msg; 
	}
...
static function print_wrap1($msg,$color='info'){
	if(Sys::Printoff||Sys::Quietmode)return;
	echo "\n";  
	$class='fsm2'.$color.' floatleft clear editbackground editcolor editfont';
...
static function close_print_wrap($msg='',$spacer=true){
	...
	$msg= '</div><!--close second print div wrap-->
	</div><!--wrap '.$msg.'-->';
	echo $msg; 
	printer::pclear();
	}
