...
//these colors are arranged for lighter to go with darker background
	...
	const Column_options='col_tag_display,col_float_calc,col_use_grid,col_grid_units,col_break_points,col_vert_pos,col_media_minmax,col_display_state,,col_pad_unit,col_mar_unit,col_animation,col_opacity,col_position,col_enable_masonry,col_width2,col_width_opt,col_min_width_opt,col_max_width_opt,col_pos_vert_val0,col_pos_horiz_val0,col_height_opt,col_min_height_opt,col_max_height_opt,col_overflowx,col_overflowy,col_height_media,col_pos_vert_val1,col_pos_horiz_val1,col_pos_vert_val2,col_pos_horiz_val2';// 
	const Box_shadow_options='shadowbox_horiz_offset,shadowbox_vert_offset,shadowbox_blur_radius,shadowbox_spread_radius,shadowbox_color,shadowbox_insideout';
     const Display_options='display_max,display_min,display_fade_px,display_fade_choice,display_fade_mode,display_fade_percent,display_fade_id,display_basis';
